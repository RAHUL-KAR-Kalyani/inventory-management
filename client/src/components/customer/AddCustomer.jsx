    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <form onSubmit={submitHandler} className="bg-white p-6 rounded-lg shadow-lg w-full sm:w-96" >
                ...
                <div className="my-2">
                    <input type="text" name="address" value={input.address} onChange={changeEventHandler} placeholder="address (Optional)" className="w-full p-3 border border-gray-300 rounded-md" />
                </div>
