            ...
            <table className="w-full border border-gray-200 border-collapse shadow-sm">
                <thead className="bg-gray-50">
                    <tr className='text-center'>
                        ...
                        <th className="px-4 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">phone</th>
                        <th className="px-4 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">email</th>
                        <th className="px-4 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">address</th>
                        <th className="px-4 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">GSTIN</th>
                        <th className="px-4 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider">Update</th>
                    </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                    {filterCustomer?.map((customer) => (
                        <tr key={customer._id} className="hover:bg-gray-50 transition-colors text-center">
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{customer.name}</td>
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{customer.phone}</td>
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{customer.email}</td>
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{customer.address}</td>
                            {/* <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{customer.GSTIN}</td> */}
                            ...
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700 flex gap-6 justify-center">
