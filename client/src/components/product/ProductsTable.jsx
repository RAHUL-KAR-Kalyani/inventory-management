            ...
            <table className="min-w-full divide-y divide-gray-200 border border-gray-200 shadow-sm">
                <thead className="bg-gray-50">
                    <tr>
                        ...
                        {/* <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Update</th> */}
                    </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                    {filterProduct?.map((product) => (
                        <tr key={product._id} className="hover:bg-gray-50 transition-colors">
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{product.name}</td>
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{product.sku}</td>
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{product.category}</td>
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{product.price}</td>
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{product.stock}</td>
                            <td className="px-4 py-2 capitalize whitespace-nowrap text-sm text-gray-700">{product.reorderLevel}</td>
