...
import titlebarLogo from '../../public/titlebarLogo.png'
...
const Navbar = ({ toggleSidebar }) => {
    ...
    return (
        <div className="navbar bg-white shadow-sm z-50 fixed top-0 left-0 w-full print:hidden flex items-center px-5">
            ...
            <button onClick={toggleSidebar} className="p-2 mr-4 rounded-md bg-gray-100 md:hidden" >
                <Menu size={24} />
            </button>
            ...
            <div className="flex-1">
                <Link to="/" className="text-xl font-semibold text-slate-900 hover:text-gray-500">
                    <img src={titlebarLogo} alt="IMT Logo" className="h-10 w-auto" />
                </Link>
            </div>
            ...
            {user && (
                <div className="flex gap-2 mr-8 items-center">
                    ...
                    <div div className="relative">
                        <button
                            ref={avatarButtonRef}
                            className="w-10 h-10 rounded-full bg-white outline-none border-2 border-gray-100 flex items-center justify-center focus:outline-none cursor-pointer"
